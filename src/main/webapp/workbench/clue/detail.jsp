...
<script type="text/javascript">
	...
	function ClueRemarkList(){
		...
		$.ajax({
			url:"workbench/clue/activityAndClueRelationList.do",
			data:{
				"id":'${c.id}'
			},
			type: "post",
			...
			success:function (data){
				...
				$.each(data,function (i,n){
					...
					html+='<td>'+n.owner+'</td>'
					html+='<td><a href="javascript:void(0);" onclick="deleteRelation(\''+n.relationId+'\')"><span class="glyphicon glyphicon-remove"></span>解除关联</a></td>'
					html+='</tr>'
...
<body>
	...
	<div style="position: relative; left: 40px; top: -30px;">
		...
		<div style="position: relative; height: 50px; width: 500px;  top: -72px; left: 700px;">
			<button type="button" class="btn btn-default" onclick="window.location.href='workbench/clue/convert.jsp?id=${c.id}&fullname=${c.fullname}&owner=${c.owner}&appellation=${c.appellation}&createBy=${c.createBy}&company=${c.company}';"><span class="glyphicon glyphicon-retweet"></span> 转换</button>
