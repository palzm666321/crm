...
<script type="text/javascript">
				...
				$.ajax({
					...
					success:function (data){
						...
						if (data.success){
							...
							html+='<font color="gray">市场活动</font> <font color="gray">-</font> <b><%--${act.name}--%></b> <small style="color: gray;"> '+data.ar.createTime+'\'由\''+data.ar.createBy+'</small>'
							...
							html+='&nbsp;&nbsp;&nbsp;&nbsp;'
							html+='<a class="myHref" href="javascript:void(0);"><span class="glyphicon glyphicon-remove" style="font-size: 20px; color: red;" onclick="delRemark(\''+data.ar.id+'\')"></span></a>'
							html+='</div>'
							html+='</div>'
							html+='</div>'
	...
	function noteContent(){
		...
		$.ajax({
			url:"activityRemarkList.do",
			dataType:"json",
			type:"post",
			success:function (data){

				//remarkList: id,noteContent,createTime,createBy,activityId,editFlag
				...
				$.each(data,function (i,n){
					...
					html+='<font color="gray">市场活动</font> <font color="gray">-</font> <b>${act.name}</b> <small style="color: gray;" id="s'+n.id+'"> '+(n.editFlag==0?n.createTime:n.editTime)+'\'由\''+(n.editFlag==0?n.createBy:n.editBy)+'</small>'
					html+='<div style="position: relative; left: 500px; top: -30px; height: 30px; width: 100px; display: none;">'
					html+='<a class="myHref" href="javascript:void(0);"><span class="glyphicon glyphicon-edit" style="font-size: 20px; color: red;" onclick="editRemark(\''+n.id+'\')"></span></a>'
					html+='&nbsp;&nbsp;&nbsp;&nbsp;'
					html+='<a class="myHref" href="javascript:void(0);"><span class="glyphicon glyphicon-remove" style="font-size: 20px; color: red;" onclick="delRemark(\''+n.id+'\')"></span></a>'
					html+='</div>'
					html+='</div>'
					html+='</div>'
	...
	function editRemark(id){
		...
		//将要修改的用户的文本信息添加到文本框
		$("#noteContent").val($.trim($("#_"+id).html()))
